...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Nouveau concept</h1>
            ...
            <form method="POST" action="{{ route('domains.concepts.store', $domain) }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="explanation" id="explanation" rows="6" required
                        class="w-full rounded-md border-gray-300 dark:bg-gray-700 dark:text-white shadow-sm @error('explanation') border-red-500 @enderror">{{ old('explanation') }}</textarea>
                    @error('explanation')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Par défaut : A revoir</p>
                    @error('status')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex justify-end">
                    <a href="{{ route('domains.concepts.index', $domain) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded mr-2">
                        Annuler
                    </a>
