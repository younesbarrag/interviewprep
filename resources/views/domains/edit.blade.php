...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 max-w-lg">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Modifier le Domaine</h1>
            ...
            <form action="{{ route('domains.update', $domain) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex gap-3 items-center">
                        ...
                        <input type="text" name="color" id="color_hex" value="{{ old('color', $domain->color) }}"
                            pattern="^#[0-9A-Fa-f]{6}$"
